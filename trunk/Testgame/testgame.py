...
character1 = pygame.transform.scale(character1, (character1.get_width()/2, character1.get_height()/2))
character2 = pygame.image.load(Patrick_image_filenames[0])
character2 = pygame.transform.scale(character2, (character2.get_width()/2, character2.get_height()/2))
